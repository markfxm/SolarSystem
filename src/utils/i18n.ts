...
const dict: { [key: string]: TranslationDict } = {
  en: {
    explorer: {
      ...
      "on": "ON",
      "off": "OFF",
      "gridHint": "Select a planet to view its surface grid.",
      "resetTime": "Reset to live time",
      "live": "LIVE",
      "eyebrow": "A JOURNEY THROUGH OUR COSMIC HOME",
      "headline": "Explore the",
      "headlineEnd": "Solar System",
      "description": "A living 3D experience of the Sun, planets, moons and beyond. Find your place among the stars.",
      "start": "Start Journey",
      "scaleNote": "Real celestial motion. Distances and sizes scaled for exploration.",
      "footer": "A SMALL PART OF A BIGGER STORY",
      "gesture": "DRAG TO ORBIT  ·  SCROLL TO EXPLORE",
      "aboutCopy": "STELLAR is an interactive window into our cosmic home. Explore the planets, follow their orbits, and discover the landscapes of Mars in a living, three-dimensional universe.",
      "marsTitle": "A closer look at the Red Planet",
      "marsCopy": "Travel to Mars, discover points of interest, and choose a landing site to explore its rugged surface.",
      "marsAction": "Explore Mars",
    ...
    mars: {
      ...
      mission_number: 'MISSION / {number}', investigate_target: 'Investigate {signal}', reach_target: 'Reach {signal}',
      scan_target: 'Scan {signal}', scanning_target: 'Scanning {signal}', mission_complete_number: 'Mission {number} completed',
      discovery02: 'Discovery complete: survey beacon. Its stored telemetry confirms the anomalous signal pattern.',
      base_terminal: 'Base Terminal', distance_base: 'Distance to base', upload_data: 'Upload Data', data_uploaded: 'Data Uploaded — Mission Complete',
      base: 'Aurora Base', signal01: 'Signal 01', signal02: 'Signal 02',
      reach_signal: 'Reach Signal 01', scan_anomaly: 'Scan the anomaly', scanning: 'Scanning anomaly',
      return_base: 'Return to Base', mission_complete: 'Mission 01 completed', paused: '(paused)',
      discovery: 'Discovery complete: KEPLER survey probe. An unusual energy signature and a second signal were recovered.',
      unlocked: 'Data delivered. Signal 02 unlocked — coordinates added to your map.',
      mission: 'MISSION / 01', investigate: 'Investigate Signal 01',
      mission_desc: 'Reach the anomaly, scan it, and return data to base.',
      signal_found: 'Signal located', suit_status: 'SUIT STATUS',
      pressure: 'Suit pressure', radiation: 'Radiation', temperature: 'Temperature',
      target_distance: 'Distance to signal', continue: 'Continue Expedition',
      vehicle_enter: 'ENTER NOMAD', vehicle_exit: 'EXIT', vehicle_blocked: 'Exit blocked',
      controls: 'WASD · MOVE / E · INTERACT / M · MINI MAP / F · FULL MAP / ESC · PAUSE',
      pause_title: 'Expedition paused', start_exploring: 'Start exploring', onboarding: 'Click Start exploring to look around and walk on Mars.',
      control_help: 'Controls', settings: 'Settings', close_map: 'Close map / Continue',
      control_details: 'WASD · Move\nMouse · Look\nE · Interact / Scan\nM · Toggle mini map\nF · Expand / Close map\nESC · Pause / Release cursor',
      location: 'LOCATION',
      surface: 'Surface',
      lat: 'Lat',
      lon: 'Lon',
      ...
      map_hint_expanded: 'Scroll to zoom · Drag to pan · Click to mark',
      map_hint_collapsed: 'Click to Expand (F)',
      close_map_paused: 'Close map',
      pois: {
    ...
    stellar: {
      ...
      defaultPosterTitle: 'My Stellar Moment',
      occasionLabel: 'Occasion',
      occasion_birthday: 'Birthday',
      occasion_couple: 'Love Story',
      occasion_baby: 'New Arrival',
      occasion_anniversary: 'Anniversary',
      occasion_custom: 'Custom',
      invalidDate: 'Enter a valid date.',
      proExport: 'HD no-watermark export',
      proSoon: 'HD no-watermark export is coming soon.',
      no_major_aspect: 'No major aspect',
      element_fire: 'Fire',
      element_earth: 'Earth',
      element_air: 'Air',
      element_water: 'Water',
      element_none: 'Balanced',
      dominantSuffix: 'Dominant',
      message_birthday: 'A personal sky map for the day you arrived.',
      message_couple: 'A shared sky for a story written together.',
      message_baby: 'A first cosmic keepsake for a new life.',
      message_anniversary: 'A keepsake for the day everything changed.',
      message_custom: 'A personal map of the sky for this moment.'
    },
    planet_meaning: {
      sun: 'Self & Ego',
  ...
  zh: {
    explorer: {
      ...
      "on": "开启",
      "off": "关闭",
      "gridHint": "选择一颗行星后查看地表网格。",
      "resetTime": "恢复实时时间",
      "live": "实时",
      "eyebrow": "一场穿越宇宙家园的旅程",
      "headline": "探索我们的",
      "headlineEnd": "太阳系",
      "description": "从太阳到行星、卫星与更远处。在实时三维宇宙中，寻找属于你的位置。",
      "start": "开启旅程",
      "scaleNote": "真实天体运动，距离与尺寸经视觉缩放以便探索。",
      "footer": "浩瀚宇宙中的一小部分",
      "gesture": "拖动环绕 · 滚动探索",
      "aboutCopy": "STELLAR 是一扇通向宇宙家园的交互窗口。探索行星，追踪轨道，发现火星地貌——一切都在浏览器中的实时三维世界里发生。",
      "marsTitle": "走近这颗红色星球",
      "marsCopy": "飞往火星，发现兴趣点，选择着陆点，探索崎岖壮丽的地表。",
      "marsAction": "探索火星",
      "selected": "你的目的地",
      "radius": "半径",
      "orbit": "公转周期",
    ...
    mars: {
      entering: '正在进入火星大气层...',
      leaving: '正在离开火星表面...',
      mission_number: '探索任务 / {number}', investigate_target: '调查{signal}', reach_target: '抵达{signal}',
      scan_target: '扫描{signal}', scanning_target: '正在扫描{signal}', mission_complete_number: '任务 {number} 已完成',
      discovery02: '发现完成：勘测信标。已恢复的遥测数据确认了异常信号特征。',
      base_terminal: '基地终端', distance_base: '距基地', upload_data: '上传数据', data_uploaded: '数据已上传 — 任务完成',
      base: '曙光基地', signal01: '01 号信号', signal02: '02 号信号',
      reach_signal: '抵达 01 号信号', scan_anomaly: '扫描异常物体', scanning: '正在扫描',
      return_base: '返回基地', mission_complete: '任务 01 已完成', paused: '（已暂停）',
      discovery: '发现完成：开普勒探测器。已记录异常能量特征和第二处信号。',
      unlocked: '数据已交付，02 号信号已解锁，坐标已添加到地图。',
      mission: '探索任务 / 01', investigate: '调查 01 号信号',
      mission_desc: '前往东侧山脊，追踪远处异常的蓝色信号。',
      signal_found: '已抵达信号源', suit_status: '宇航服状态',
      pressure: '内部气压', radiation: '辐射', temperature: '温度',
      target_distance: '距信号源', continue: '继续探索',
      vehicle_enter: '进入 NOMAD', vehicle_exit: '下车', vehicle_blocked: '下车位置被阻挡',
      controls: 'WASD · 移动 / E · 交互 / M · 小地图 / F · 完整地图 / ESC · 暂停',
      pause_title: '探索已暂停', start_exploring: '开始探索', onboarding: '点击开始探索，使用鼠标查看四周，在火星上行走。',
      control_help: '控制说明', settings: '设置', close_map: '关闭地图 / 继续探索',
      control_details: 'WASD · 移动\n鼠标 · 查看\nE · 交互 / 扫描\nM · 开关小地图\nF · 展开 / 关闭地图\nESC · 暂停 / 释放鼠标',
      return_orbit: '返回轨道',
      location: '当前位置',
      surface: '地表',
      lat: '纬度',
      ...
      map_hint_expanded: '滚轮缩放 · 拖动平移 · 点击标记',
      map_hint_collapsed: '点击展开 (F)',
      close_map_paused: '关闭地图',
      pois: {
        olympus_mons: '奥林匹斯山',
    ...
    stellar: {
      ...
      theme_golden: '黄金唱片',
      titleLabel: '海报标题',
      defaultPosterTitle: '我的星空时刻',
      occasionLabel: '纪念类型',
      occasion_birthday: '生日',
      occasion_couple: '情侣',
      occasion_baby: '宝宝',
      occasion_anniversary: '纪念日',
      occasion_custom: '自定义',
      invalidDate: '请输入有效日期。',
      proExport: '高清无水印导出',
      proSoon: '高清无水印导出即将开放。',
      no_major_aspect: '无主要相位',
      element_fire: '火象',
      element_earth: '土象',
      element_air: '风象',
      element_water: '水象',
      element_none: '平衡',
      dominantSuffix: '主导',
      message_birthday: '属于你来到这个世界那天的星空地图。',
      message_couple: '为共同书写的故事保存这一刻的星空。',
      message_baby: '送给新生命的第一份宇宙纪念。',
      message_anniversary: '纪念那个让一切开始改变的日子。',
      message_custom: '为这一刻保存一张专属星空地图。'
    },
    planet_meaning: {
      sun: '自我与显意识',
      mercury: '思维与沟通',

# 🌌 Stellar Web: 星际启航 | Interstellar Odyssey
...
## 🚀 欢迎来到未来
**Stellar Web** 是一场穿越时空的 3D 星际旅行。我们利用尖端的网络图形技术，在您的浏览器中重构了整个太阳系。这不仅仅是一个模型，这是一个活生生的宇宙实验室，等待着每一位航行者的探索。
...
**Stellar Web** is a 3D interstellar odyssey through space and time. Leveraging cutting-edge web graphics, we have reconstructed the entire solar system within your browser. This is more than a model—it is a living cosmic laboratory awaiting exploration by every interstellar traveler.
...
- **Panoramic View**:
  ...
  - `Right Navigation Panel`: Rapid warp to specific planets
- **Mars Surface Mode**:
  - `W` `A` `S` `D`: Movement/Walking
  - `Mouse Move`: Look around
  - `Click Screen`: Lock/Release cursor for immersive exploration
